...
use app\models\SearchThesisStaff;

/**
 * StaffthesisController implements the CRUD actions for Thesis model.
 */
class StaffthesisController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new SearchThesisStaff();
